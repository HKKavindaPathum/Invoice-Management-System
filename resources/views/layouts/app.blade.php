...
<html lang="en">
    ...
    <body class="font-sans antialiased text-slate-800 bg-slate-50">
        <div class="min-h-screen flex flex-col md:flex-row">
            <!-- Sidebar -->
            <div id="sidebar" class="w-64 bg-slate-900 text-slate-300 p-6 fixed -left-full md:left-0 top-16 bottom-0 overflow-y-auto shadow-2xl transition-all duration-300 z-30 border-r border-slate-800/60">
                <div class="flex justify-between items-center mb-6 md:hidden">
                    <h2 class="text-xs font-semibold tracking-wider text-slate-500 uppercase">Navigation</h2>
                    <button id="sidebarCloseMobile" class="text-slate-400 hover:text-white transition">
                ...
                <nav class="space-y-1 text-sm font-medium">
                    <a href="{{ route('dashboard') }}"
                        ...
                        {{ request()->routeIs('dashboard') 
                            ? 'bg-indigo-600/90 text-white shadow-lg shadow-indigo-600/20 border-l-4 border-indigo-400 font-semibold' 
            ...
            <!-- Main Content -->
            <div class="flex-1 bg-slate-50/50 md:ml-64 flex flex-col min-h-screen">
                <!-- Navigation Bar -->
